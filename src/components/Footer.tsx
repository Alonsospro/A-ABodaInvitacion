...
import { Heart, Settings, RefreshCcw } from 'lucide-react';
...
export const Footer: React.FC<FooterProps> = ({ onOpenSettings, onChangeCode }) => {
  return (
      ...
      <div className="max-w-3xl mx-auto flex flex-col items-center">
        ...
        <div className="flex flex-wrap items-center justify-center gap-4 text-xs font-sans-clean text-[#8C847B]">
          ...
          >
            ...
            <span>Configuración Google Sheets</span>
          </button>
        </div>
