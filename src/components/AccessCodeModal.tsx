...
export const AccessCodeModal: React.FC<AccessCodeModalProps> = ({ onUnlock, onOpenSettings }) => {
        ...
        {onOpenSettings && (
          <div className="text-center mt-3">
            <button
              ...
              type="button"
              className="text-[10px] font-sans-clean text-white/70 hover:text-white transition-colors"
            >
              Configuración
            </button>
          </div>
