...
/**
 * URL permanente y fija de Google Apps Script vinculada a Google Sheets
 */
export const GOOGLE_APPS_SCRIPT_URL = 'https://script.google.com/macros/s/AKfycbwNgA8W0X47vYqCqgV93xBnIsGktqp32hy_eUXVDRBEf3Jejnt62OfcXtcjk4-6QZYkog/exec';
...
export function setStoredAppsScriptUrl(_url: string): void {
  // No-op: La URL está fija y definida en el código
}
